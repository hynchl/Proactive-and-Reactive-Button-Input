...
def RunPersistence(InputData):
    ...
    ExtremaAndPersistence = np.full((NumElements, 2), np.inf) #HC
    idx_EAP = 0 #HC

    # ~ 
    # append = ExtremaAndPersistence.append #HC
    ...
    for idx in SortedIdx:
        ...
        if (NumNeighborComponents == 0):
            ...
            ExtremaAndPersistence[idx_EAP,0] = idxHighestMinimum #HC
            ExtremaAndPersistence[idx_EAP,1] = Persistence #HC
            # print(Persistence)
            idx_EAP+=1 #HC
            ExtremaAndPersistence[idx_EAP,0] = idx #HC
            ExtremaAndPersistence[idx_EAP,1] = Persistence#HC
            idx_EAP+=1 #HC
    ...
    ExtremaAndPersistence[idx_EAP,0] = idxGlobalMinimum #HC
    ExtremaAndPersistence[idx_EAP,1] = np.inf #HC
    idx_EAP+=1
    ...
    return ExtremaAndPersistence[:idx_EAP]
